                ...
                <div class="mb-3 mb-xl-0">
                    <div class="btn-group dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuDate" data-x-placement="bottom-end">
                            <a class="dropdown-item" href="empty#">2015</a>
                            <a class="dropdown-item" href="empty#">2016</a>
                            <a class="dropdown-item" href="empty#">2017</a>
                            <a class="dropdown-item" href="empty#">2018</a>
                        </div>
                    </div>
                </div>
            </div>
