    ...
    <div class="container-fluid">
        <div class="main-header-left ">
            <div class="responsive-logo">
                <a href="index"><img src="{{ asset('img/brand/logo.png') }}" class="logo-1" alt="logo"></a>
                <a href="index"><img src="{{ asset('img/brand/logo-white.png') }}" class="dark-logo-1" alt="logo"></a>
                <a href="index"><img src="{{ asset('img/brand/favicon.png') }}" class="logo-2" alt="logo"></a>
                <a href="index"><img src="{{ asset('img/brand/favicon.png') }}" class="dark-logo-2" alt="logo"></a>
            </div>
                ...
                <div class="dropdown nav-item main-header-message ">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <div class="main-message-list chat-scroll">
                            ...
                            <a href="empty#" class="p-3 d-flex border-bottom">
                                <div class="drop-img cover-image" data-image-src="https://laravel.spruko.com/valex/leftmenu-light-ltr/assets/img/faces/2.jpg">
                                    <span class="avatar-status bg-teal"></span>
                                </div>
                                <div class="wd-90p">
                                    <div class="d-flex">
                            ...
                            <a href="empty#" class="p-3 d-flex border-bottom">
                                <div class="drop-img cover-image" data-image-src="https://laravel.spruko.com/valex/leftmenu-light-ltr/assets/img/faces/9.jpg">
                                    <span class="avatar-status bg-teal"></span>
                                </div>
                                <div class="wd-90p">
                                    <div class="d-flex">
                            ...
                            <a href="empty#" class="p-3 d-flex border-bottom">
                                <div class="drop-img cover-image" data-image-src="https://laravel.spruko.com/valex/leftmenu-light-ltr/assets/img/faces/12.jpg">
                                    <span class="avatar-status bg-teal"></span>
                                </div>
                                <div class="wd-90p">
                                    <div class="d-flex">
                            ...
                            <a href="empty#" class="p-3 d-flex border-bottom">
                                <div class="drop-img cover-image" data-image-src="https://laravel.spruko.com/valex/leftmenu-light-ltr/assets/img/faces/5.jpg">
                                    <span class="avatar-status bg-teal"></span>
                                </div>
                                <div class="wd-90p">
                                    <div class="d-flex">
